...
public class Protocol {
    ...
    public static Command readCommand(InputStream is) throws Exception {
        ...
        if (list.size() < 1) {
            throw new Exception("the size must bigger than 1");
        }
        ...
        String className = String.format("com.hl.commands.%sCommand", commandName.toUpperCase());
    ...
    public static void writeArray(OutputStream os, List<?> result) throws Exception {
        os.write('*');
    ...
    public static void writeBulkString(OutputStream os, String s) throws IOException {
        ...
        os.write('$');
        os.write(String.valueOf(buffer.length).getBytes());
        os.write("\r\n".getBytes());
        os.write(buffer);
        os.write("\r\n".getBytes());
    }
